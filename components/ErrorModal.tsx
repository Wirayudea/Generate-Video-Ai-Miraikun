    ...
    <div
      ...
      <div
        ...
        <div className="mt-8 flex justify-center gap-4">
          <button
            onClick={onSelectKey}
            className="px-8 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800">
            Select Cloud Project
          </button>
          <button
            onClick={onClose}
            className="px-8 py-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-white font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800">
            Close
          </button>
        </div>
      </div>
